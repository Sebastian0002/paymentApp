          ...
          return Column(
            children: [
              Transform(
                  ...
                  transform: Matrix4.identity()..setEntry(3, 2, 0.001)..rotateX(selectionValue),
                  child: SizedBox(
                    height: height,
    ...
    _controllerMovement.forward();
      await Navigator.push(
        ...
        PageRouteBuilder(
          ...
          FadeTransition(
            opacity: animation,
            child: PaymentScreen(cardData: cardData))
        )  
      );
...
class CreditCardTranslated extends AnimatedWidget {
  const CreditCardTranslated({
    ...
    super.key}): super(listenable: animation);
        ...
        child: Hero(
          ...
          child: Transform(
            ...
            transform: Matrix4.identity()
                        ..setEntry(3, 2, 0.001)
                        ..translate(0.0, yFactor*animation.value*MediaQuery.sizeOf(context).height, index * 50.0),
            child: GestureDetector(
              onTap: (){
                onTap(card);
              },
