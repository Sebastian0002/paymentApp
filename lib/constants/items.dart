...
List<Item> items = [
  Item(
    ...
    likes: 97,
    category: EnumItemCategory.headphones,
  ),
  Item(
    name: "Play Station 5",
    ...
    likes: 50,
    category: EnumItemCategory.consoles,
  ),
  Item(
    name: "Xbox One",
  ...
  Item(
      ...
      likes: 100,
      category: EnumItemCategory.smartphones,
  ...
  Item(
      ...
      likes: 55,
      category: EnumItemCategory.laptops,
      properties: Properties(storages: [
        2048,
        1024,
        512,
  ...
  Item(
      ...
      likes: 55,
      category: EnumItemCategory.clothes,
...
final List<ItemCategory> categoryItems = [
  ItemCategory(name: "All", category: EnumItemCategory.all),
  ItemCategory(name: "Laptops", category: EnumItemCategory.laptops),
  ItemCategory(name: "Headphones", category: EnumItemCategory.headphones),
  ItemCategory(name: "Consoles", category: EnumItemCategory.consoles),
  ItemCategory(name: "Smartphones", category: EnumItemCategory.smartphones),
  ItemCategory(name: "Clothes", category: EnumItemCategory.clothes),
];
